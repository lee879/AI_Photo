...
class ResNet_Discriminator(Model): # 残差卷积鉴别器
    def __init__(self):
        ...
        self.layer_2 = self.build_resblock(filter_num=256,kernel_size=3,strides=2,)
        self.layer_3 = self.build_resblock(filter_num=128,kernel_size=3,strides=2,)
        #self.layer_40 = self.build_resblock(filter_num=32, kernel_size=7, strides=1, )
        self.layer_41 = self.build_resblock(filter_num=64, kernel_size=3, strides=2, )
        #self.layer_42 = self.build_resblock(filter_num=64, kernel_size=5, strides=1, )
        self.layer_5 = self.build_resblock(filter_num=64, kernel_size=3, strides=2,)
        self.layer5_M = Self_Attention(64)
        self.layer_6_conv = keras.layers.Conv2D(64,3,1,"same",activation=tf.nn.leaky_relu)
        ...
        self.layer_6 = keras.layers.Dense(1)
...
if __name__ == "__main__":
    ...
    # x = tf.random.uniform([100, 64,64,3],maxval=1,minval=-1)
    # y = res(x)
    # print("-------------------------")
    # print(y.shape)
